          ...
          <div className="mb-16">
            <div className="grid lg:grid-cols-3 gap-12 items-start mb-16">
              <div className="lg:col-span-2">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">Meanwhile in London, Layli had been opening up to the idea of meeting someone new. After slowly losing hope in finding the right person on her own, she'd started asking friends if they knew any nice guys worth meeting. She hadn't reached out to Dawning, an old friend who happened to be Raaz's sister-in-law, but surprisingly, Dawning contacted her with a message about her brother-in-law who "can be charming and charismatic when he wants to be." When Dawning insisted they should meet, Layli agreed.</p>
              </div>
              <div>
            ...
            <div className="grid lg:grid-cols-3 gap-12 items-start mb-16">
              ...
              <div className="lg:col-span-2">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">While Raaz was planning his transition back to life in Chicago in early 2024, his sister-in-law Dawning was on a mission. She was determined that he should meet her wonderful friend Layli while Raaz was in London. Raaz, focused on finding a new job and settling down, wasn't particularly keen on the idea—especially not a long-distance relationship during such a transitional time. Although Raaz and Layli both agreed to meet, the meeting never happened and Raaz flew back to Chicago.</p>
